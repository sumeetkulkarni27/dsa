...
class Main{
    ...
    make_glow = (flag)=>{
        ...
        if(flag){
        //    document.getElementById("shuffle1_cont").style.display="flex"
           document.querySelector(".container_one").style.border = "5px solid #4a39ef"
        }
        // make player2 card glow
        else{
            // document.getElementById("shuffle2_cont").style.display="flex"
           document.querySelector(".container_two").style.border = "5px solid #4a39ef"
    ...
    change_card(player1){
        document.getElementById("player1_card").src = "../img/stack/player1.png"
        document.getElementById("player2_card").src= "../img/stack/player2.png"
        

        // player 1 is active
        if(player1){
            document.getElementById("player1_card").src = "../img/stack/"+this.card_obj_list[this.player1_peep()][0]
        }
        // player2 is active
        else{
            document.getElementById("player2_card").src= "../img/stack/"+this.card_obj_list[this.player2_peep()][0]
        }

        setTimeout(()=>{
            if(this.floor.length>0){
                document.getElementById("img_board").src = "../img/stack/"+this.card_obj_list[this.floor_peep()][0]
                if(player1){
                    document.getElementById("player1_card").src = "../img/stack/player1.png"
                }
                // player2 is active
    ...
    game_end(player1){
        ...
        win_gif.src = "../img/stack/party.gif"
